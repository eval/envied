...
require 'envied/coercer/base_type'
require 'envied/coercer/boolean_type'
require 'envied/coercer/date'
require 'envied/coercer/float'
require 'envied/coercer/integer'
require 'envied/coercer/string_type'
require 'envied/coercer/symbol'
